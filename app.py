...
def index():
    if request.method == 'GET':
        ...
        datum = requests.get('https://fmpcloud.io/api/v3/quote/' +
                             symbol+'?apikey=7eacbf4424fba9a4ec4952e6584e0ee6')
        ...
        if len(result_data) < 1:
            ResData = {
                'msg': "No such stock symbol found! Sorry :( Please enter correct symbol!"}
            ...
            ResData = {'dateTimeNow': dateTimeNow, 'NameofStock': NameofStock,
                       'price': price, 'valueChange': valueChange, 'perChange': perChange}
